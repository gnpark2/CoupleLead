...
//     @KafkaListener(topics = "couple-anniversary-updated", groupId = "widget-cache-group")
//     public void consume(CoupleAnniversaryUpdatedEvent event) {
//         log.info("기념일 이벤트 수신: {}", event);

//         widgetCacheService.refreshCache(event.coupleId());
//     }
// }
