...
import com.example.couplead.anniversary.dto.request.UpdateHomeAnniversarySelectionRequest;
...
public class AnniversaryController {
    ...
    @PostMapping
    public ApiResponse<AnniversaryResponse> create(@AuthenticationPrincipal CustomUserDetails userDetails,
    ...
    public ApiResponse<AnniversaryResponse> update(@AuthenticationPrincipal CustomUserDetails userDetails,
            @PathVariable Long anniversaryId, @Valid @RequestBody UpdateAnniversaryRequest request) {
        return ApiResponse.success(
    ...
    @GetMapping("/home")
    public ApiResponse<List<AnniversaryResponse>> getHomeAnniversaries(
            @AuthenticationPrincipal CustomUserDetails userDetails) {

        return ApiResponse.success(
                anniversaryService
                        .getHomeAnniversaries(
                                userDetails
                                        .getUser()
                                        .getId()));
    }
    ...
    @PutMapping("/home")
    public ApiResponse<List<AnniversaryResponse>> updateHomeAnniversaries(
            @AuthenticationPrincipal CustomUserDetails userDetails,

            @Valid @RequestBody UpdateHomeAnniversarySelectionRequest request) {

        return ApiResponse.success(
                anniversaryService
                        .updateHomeAnniversaries(
                                userDetails
                                        .getUser()
                                        .getId(),

                                request.anniversaryIds()));
    }
}
